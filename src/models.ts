...
// glm-5.2 and kimi-k3 populate both content and reasoning_content (unlike the
// older glm-4.5/5.1/deepseek-r1 generation, which returned empty content).
...
// Note: kimi-k3 can consume the entire maxTokens budget on reasoning before
// emitting content — pass a generous maxTokens (e.g. 500+) or content may
// come back empty with finishReason "length".
export const REASONING_MODELS: ReadonlySet<string> = new Set<string>(["glm-5.2", "kimi-k3"]);
